            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ContactItem(
                    icon: Icons.email,
                    text: state.contactInfo?.email ?? 'am6888122@gmail.com',
                    onTap: () => _launchUrl(
                      'mailto:${state.contactInfo?.email ?? 'am688122@gmail.com'}',
                    ),
                  ),
                ),
                Padding(
                ...
                Padding(
                  ...
                  child: ContactItem(
                    icon: Icons.call,
                    text: state.contactInfo?.phone ?? '+201099876619',
                    onTap: () => _launchUrl(
                      'tel:${state.contactInfo?.phone ?? '+201099876619'}',
                    ),
                  ),
                ),
              ],
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () => _showCreateTicketDialog(context, l10n),
                  ),
                ],
              ),
              const Divider(),
