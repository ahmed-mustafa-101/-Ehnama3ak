...
class _AddSessionScreenState extends State<AddSessionScreen> {
  ...
  String? get _selectedFilePath =>
      _selectedPlatformFile?.path ?? _selectedImageOrVideo?.path;
  String? get _selectedFileName =>
      _selectedPlatformFile?.name ?? _selectedImageOrVideo?.name;
      ...
      listener: (context, state) {
        if (state is DoctorSessionCreateSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(l10n.sessionAdded),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildPickerField(
                          text:
                              _selectedFileName ??
                              "Upload ${_getFileLabel(l10n).toLowerCase()}",
                          onTap: _pickFile,
                        ),
                        const SizedBox(height: 20),
                        Text(
                          ...
                          child:
                              ...
                              >(
                                builder: (context, state) {
                                  final isLoading =
                                      state is DoctorSessionCreating;
                                  return SizedBox(
                                    width: 160,
                                    height: 45,
                                    child: ElevatedButton.icon(
                                      ...
                                      label: Text(
                                        isLoading ? l10n.saving : l10n.add,
                                        style: const TextStyle(
                                          fontWeight: FontWeight.w600,
                                        ),
                                      ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected
                ...
                : (isDarkMode ? const Color(0xFF2C2C2C) : Colors.grey.shade300),
