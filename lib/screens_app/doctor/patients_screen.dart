...
class _DoctorPatientsScreenState extends State<DoctorPatientsScreen> {
        ...
        Padding(
          ...
          child: Container(
            ...
            child: TextField(
              ...
              onChanged: (value) => context.read<DoctorPatientsCubit>().searchPatients(value),
          ...
          child: RefreshIndicator(
            ...
            child: BlocBuilder<DoctorPatientsCubit, DoctorPatientsState>(
              builder: (context, state) {
                if (state is DoctorPatientsLoading || state is DoctorPatientsSearching) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _patientItem(context, patient.fullName ?? 'Unknown',
                          patient.diagnosis ?? 'No Diagnosis', patient.lastSessionDate ?? 'N/A',
                          patient.profileImageUrl, patient.id, l10n);
                    },
                  );
                }
  ...
  Widget _buildEmptyState(AppLocalizations l10n) {
    return ListView(physics: const AlwaysScrollableScrollPhysics(), children: [
      ...
      Center(child: Column(children: [
        ...
        Text(l10n.noPatients, style: const TextStyle(color: Colors.grey, fontSize: 16)),
      ])),
    ]);
  }
  ...
  Widget _buildErrorState(String message, AppLocalizations l10n) {
    return ListView(physics: const AlwaysScrollableScrollPhysics(), children: [
      ...
      Center(child: Padding(padding: const EdgeInsets.all(30), child: Column(children: [
        ...
        const SizedBox(height: 20),
        ElevatedButton(
          onPressed: () => context.read<DoctorPatientsCubit>().fetchPatients(),
  ...
  Widget _patientItem(BuildContext context, String name, String condition, String lastSession,
      String? imageUrl, String? id, AppLocalizations l10n) {
    return Container(
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: (imageUrl == null || imageUrl.isEmpty) ? const Icon(Icons.person, color: Color(0xFF0DA5FE)) : null,
          ),
          const SizedBox(width: 15),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            Text(condition, style: TextStyle(color: Colors.grey.shade600, fontSize: 12)),
            Text('${l10n.lastSession}: $lastSession', style: TextStyle(color: Colors.grey.shade400, fontSize: 10)),
          ])),
          Row(children: [
            IconButton(
              onPressed: () {
                if (id != null) {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => MessageDetailScreen(
                      receiverId: id, receiverName: name, receiverProfileImage: imageUrl)));
                }
              },
