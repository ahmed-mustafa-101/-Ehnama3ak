              ...
              children: [
                ...
                screenWidth < 400
                    ...
                    : Row(
                        children: [
                          ...
                          Expanded(child: _callButton(context, state.contactInfo?.phone)),
                        ],
                      ),
                SizedBox(height: Responsive.spacing(context, 30)),
                ...
                Padding(
                  ...
                  child: ContactItem(
                    ...
                    onTap: () {
                      _launchUrl('mailto:${state.contactInfo?.email ?? 'support@gmail.com'}');
                    },
                  ),
                ),
                Padding(
                ...
                Padding(
                  ...
                  child: ContactItem(
                    ...
                    onTap: () {
                      _launchUrl('tel:${state.contactInfo?.phone ?? '+44123456789'}');
                    },
                  ),
                ),
              ],
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    const Text('Support Tickets', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    IconButton(icon: const Icon(Icons.add), onPressed: () => _showCreateTicketDialog(context)),
                  ],
                ),
                const Divider(),
                Expanded(
    ...
    showDialog(
      ...
      builder: (diagContext) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              context.read<HelpCubit>().createTicket(subjectController.text, descController.text);
    ...
    showDialog(
      ...
      builder: (diagContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            TextField(controller: subjectController, decoration: const InputDecoration(labelText: 'Subject')),
            TextField(controller: messageController, decoration: const InputDecoration(labelText: 'Message'), maxLines: 5),
          ],
        ),
        actions: [
          TextButton(onPressed: () => Navigator.pop(diagContext), child: const Text('Cancel')),
          ElevatedButton(
            onPressed: () {
              context.read<HelpCubit>().sendSupportEmail(subjectController.text, messageController.text);
              Navigator.pop(diagContext);
            },
